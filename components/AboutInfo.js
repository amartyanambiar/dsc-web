      ...
      <div className="md:w-4/5 w-11/12   rounded-lg px-4  py-2  my-10 m-auto text-center">
        ...
        <div className=" lg:mx-2 my-5 m-auto bg-purple-600 bg-opacity-25 transition duration-500 ease-in transform hover:-translate-y-1 hover:scale-105 ">
          ...
          <div className="rounded-lg bg-opacity-75 bg-purple-600">
            ...
            {/* <img src="/about_us.jpg" className="md:w-80 sm: mx-auto "></img> */}
          </div>
        </div>
        {/* Goals starts */}
        ...
        <div className="lg:flex justify-between items-start items-stretch ">
          ...
          <Goal
            ...
            goalText="Through education and collaboration we want to provide students a platform where they can innovate and experiment along with us. Developing innovative products is what separates one from the crowd. Therefore, we want to lay the foundation necessary to bring our innovative visions to life through the power of technology."
          />
        </div>
      </div>
      {/* Mission ends */}
